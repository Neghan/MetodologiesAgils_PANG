...
platformer.level1 ={
    ...
    preload:function(){ 
        this.load.image('bg','assets/img/bg_green_tile.png');
        this.load.tilemap('level1','assets/tilemaps/level1.json',null,Phaser.Tilemap.TILED_JSON);
        this.load.image('walls','assets/img/tileset_wall_lv1.png');
        this.load.image('moss','assets/img/tileset_edge_lv1.png');
        this.load.spritesheet('hero','assets/img/hero.png',32,32);
